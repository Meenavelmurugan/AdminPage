...
public class ViewServletAD extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<EmpAD> list = EmpDaoAD.getAllComponents(search, type, status, location);
        ...
        // Display table rows
        for (EmpAD e : list) {
            out.print("<tr><td>" + e.getCid() + "</td><td>" + e.getType() + "</td><td>" + e.getModel() + "</td><td>" + e.getStatus() + "</td><td>" + e.getLocation() + "</td><td>" + e.getVid() + "</td><td><a href='EditServletAD?cid=" + e.getCid() + "' class='btn btn-edit'>Edit</a></td><td><a href='DeleteServletAD?cid=" + e.getCid() + "' class='btn btn-delete' onclick='return confirmDelete()'>Delete</a></td></tr>");
        }
        out.print("</table>");
